...
function RegistrarAdmin(req, res){
    ...
    usuariosModel.departamento = 'Guatemala';
...
function registrarCliente(req, res){
    ...
    if(parametros.nombre, parametros.email, parametros.direccion, parametros.departamento){
        usuariosModel.nombre = parametros.nombre;
        usuariosModel.email =  parametros.email;
        usuariosModel.direccion = parametros.direccion;
        usuariosModel.departamento = parametros.departamento;
